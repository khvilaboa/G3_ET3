							   ...
							   <form class="form-horizontal" role="form">
								  ...
								  <div class="form-group">
									 <label for="passwdAct" class="col-lg-2 control-label"><?php echo $textos[8];//Contrase&ntilde;a actual?></label>
										<div class="col-lg-10">
										   <input type="password" class="form-control" id="passwdAct" placeholder="<?php echo $textos[8];//Contrase&ntilde;a actual?>">
										</div>
								  </div>
								  ...
								  <div class="form-group">
									 <label for="passwdNew" class="col-lg-2 control-label"><?php echo $textos[9];//Nueva contrase&ntilde;a?></label>
										<div class="col-lg-10">
										   <input type="password" class="form-control" id="passwdNew" placeholder="<?php echo $textos[9];//Nueva contrase&ntilde;a?>">
										</div>
								  </div>
								  ...
								  <div class="form-group">
									 <label for="passwdRep" class="col-lg-2 control-label"><?php echo $textos[10];//Repetir contrase&ntilde;a?></label>
										<div class="col-lg-10">
										   <input type="password" class="form-control" id="passwdRep" placeholder="<?php echo $textos[10];//Repetir contrase&ntilde;a?>">
										</div>
								  </div>
								  ...
								  <div class="form-group">
									 <label class="col-lg-2 control-label">E-mail</label>
										<div class="col-lg-10">
											<input type="email" class="form-control" id="inputEmail" placeholder="<?php echo $textos[12];//Introduce tu email?>">
										</div>
								  </div>
								  
								  <div class="pull-right"> 
									<button type="button" class="btn ex-button"><?php echo $textos[11];//Modificar Perfil?></button>
								  </div>
							   </form>
